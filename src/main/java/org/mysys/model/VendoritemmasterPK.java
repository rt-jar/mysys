...
/**
 * The primary key class for the vendoritemmaster database table.
 * 
 */
@Embeddable
public class VendoritemmasterPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VendoritemmasterPK)) {
			return false;
		}
		VendoritemmasterPK castOther = (VendoritemmasterPK)other;
		return 
