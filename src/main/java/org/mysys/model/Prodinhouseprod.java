...
/**
 * The persistent class for the prodinhouseprod database table.
 * 
 */
@Entity
@NamedQuery(name="Prodinhouseprod.findAll", query="SELECT p FROM Prodinhouseprod p")
public class Prodinhouseprod implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private ProdinhouseprodPK id;
	...
	public Prodinhouseprod() {
	}

	public ProdinhouseprodPK getId() {
		return this.id;
	}

	public void setId(ProdinhouseprodPK id) {
		this.id = id;
	}
